// Use JavaScript, Leaflet, D3 to display earthquake data available from the U.S. Geological Survey (USGS)
...
// Add three layer groups for allEarthquakes, tectonic plate, & majorEarthquakes.
let allEarthquakes = new L.layerGroup();
let tectonicPlates = new L.layerGroup();
let majorEarthquakes = new L.layerGroup();
let pastDay = new L.layerGroup();

// Add a reference to the tectonic plates group to the overlays object.
let overlays = {
  "Earthquakes: Past Day": pastDay,
  "Earthquakes: Past Week": allEarthquakes,
  "Major Earthquakes": majorEarthquakes,
  "Tectonic Plates": tectonicPlates
};

// Add GeoJSON Earthquake data URL.
let pastDayData = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson";
...
////
//// Add layer for Major Earthquakes.
////
...
// Use d3.json to make a call to get our Tectonic Plate geoJSON data.
d3.json(pastDayData).then(function(data) {
  // console.log(data);
